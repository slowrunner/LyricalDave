...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, dave_interfaces::srv::Undock_Request>, int> = 0>
...
template<>
constexpr const char * data_type<dave_interfaces::srv::Undock_Request>()
{
  return "dave_interfaces::srv::Undock_Request";
}

template<>
constexpr const char * name<dave_interfaces::srv::Undock_Request>()
{
  return "dave_interfaces/srv/Undock_Request";
}
...
template<>
struct MessageTraits<dave_interfaces::srv::Undock_Request>
{
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, dave_interfaces::srv::Undock_Response>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
...
template<>
constexpr const char * data_type<dave_interfaces::srv::Undock_Response>()
{
  return "dave_interfaces::srv::Undock_Response";
}

template<>
constexpr const char * name<dave_interfaces::srv::Undock_Response>()
{
  return "dave_interfaces/srv/Undock_Response";
}
...
template<>
struct MessageTraits<dave_interfaces::srv::Undock_Response>
{
...
inline std::string to_yaml(const Undock_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
template<typename T, std::enable_if_t<std::is_same_v<std::decay_t<T>, dave_interfaces::srv::Undock_Event>, int> = 0>
constexpr auto as_tuple_ref(T && msg)
{
  return std::forward_as_tuple(
...
template<>
constexpr const char * data_type<dave_interfaces::srv::Undock_Event>()
{
  return "dave_interfaces::srv::Undock_Event";
}

template<>
constexpr const char * name<dave_interfaces::srv::Undock_Event>()
{
  return "dave_interfaces/srv/Undock_Event";
}

template<>
struct has_fixed_size<dave_interfaces::srv::Undock_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<dave_interfaces::srv::Undock_Event>
  : std::integral_constant<bool, has_bounded_size<dave_interfaces::srv::Undock_Request>::value && has_bounded_size<dave_interfaces::srv::Undock_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<dave_interfaces::srv::Undock_Event>
  : std::true_type {};

template<>
struct MessageTraits<dave_interfaces::srv::Undock_Event>
{
...
template<>
constexpr const char * data_type<dave_interfaces::srv::Undock>()
{
  return "dave_interfaces::srv::Undock";
}

template<>
constexpr const char * name<dave_interfaces::srv::Undock>()
{
  return "dave_interfaces/srv/Undock";
}
