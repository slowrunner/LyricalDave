...
ros2_gopigo3_msg__srv__SPI_Request__create(void)
{
...
ros2_gopigo3_msg__srv__SPI_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
bool
ros2_gopigo3_msg__srv__SPI_Event__init(ros2_gopigo3_msg__srv__SPI_Event * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    ros2_gopigo3_msg__srv__SPI_Event__fini(msg);
    return false;
  }
  // request
  if (!ros2_gopigo3_msg__srv__SPI_Request__Sequence__init(&msg->request, 0)) {
    ros2_gopigo3_msg__srv__SPI_Event__fini(msg);
    return false;
  }
  // response
  if (!ros2_gopigo3_msg__srv__SPI_Response__Sequence__init(&msg->response, 0)) {
    ros2_gopigo3_msg__srv__SPI_Event__fini(msg);
    return false;
  }
  return true;
...
void
ros2_gopigo3_msg__srv__SPI_Event__fini(ros2_gopigo3_msg__srv__SPI_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  // request
  ros2_gopigo3_msg__srv__SPI_Request__Sequence__fini(&msg->request);
  // response
  ros2_gopigo3_msg__srv__SPI_Response__Sequence__fini(&msg->response);
}

bool
ros2_gopigo3_msg__srv__SPI_Event__are_equal(const ros2_gopigo3_msg__srv__SPI_Event * lhs, const ros2_gopigo3_msg__srv__SPI_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!ros2_gopigo3_msg__srv__SPI_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!ros2_gopigo3_msg__srv__SPI_Response__Sequence__are_equal(
...
bool
ros2_gopigo3_msg__srv__SPI_Event__copy(
  const ros2_gopigo3_msg__srv__SPI_Event * input,
  ros2_gopigo3_msg__srv__SPI_Event * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // request
  if (!ros2_gopigo3_msg__srv__SPI_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!ros2_gopigo3_msg__srv__SPI_Response__Sequence__copy(
...
ros2_gopigo3_msg__srv__SPI_Event *
ros2_gopigo3_msg__srv__SPI_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_gopigo3_msg__srv__SPI_Event * msg = (ros2_gopigo3_msg__srv__SPI_Event *)allocator.allocate(sizeof(ros2_gopigo3_msg__srv__SPI_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros2_gopigo3_msg__srv__SPI_Event));
  bool success = ros2_gopigo3_msg__srv__SPI_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
ros2_gopigo3_msg__srv__SPI_Event__destroy(ros2_gopigo3_msg__srv__SPI_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    ros2_gopigo3_msg__srv__SPI_Event__fini(msg);
...
bool
ros2_gopigo3_msg__srv__SPI_Event__Sequence__init(ros2_gopigo3_msg__srv__SPI_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_gopigo3_msg__srv__SPI_Event * data = NULL;

  if (size) {
    data = (ros2_gopigo3_msg__srv__SPI_Event *)allocator.zero_allocate(size, sizeof(ros2_gopigo3_msg__srv__SPI_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros2_gopigo3_msg__srv__SPI_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ros2_gopigo3_msg__srv__SPI_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
ros2_gopigo3_msg__srv__SPI_Event__Sequence__fini(ros2_gopigo3_msg__srv__SPI_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ros2_gopigo3_msg__srv__SPI_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
ros2_gopigo3_msg__srv__SPI_Event__Sequence *
ros2_gopigo3_msg__srv__SPI_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_gopigo3_msg__srv__SPI_Event__Sequence * array = (ros2_gopigo3_msg__srv__SPI_Event__Sequence *)allocator.allocate(sizeof(ros2_gopigo3_msg__srv__SPI_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ros2_gopigo3_msg__srv__SPI_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
ros2_gopigo3_msg__srv__SPI_Event__Sequence__destroy(ros2_gopigo3_msg__srv__SPI_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ros2_gopigo3_msg__srv__SPI_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
ros2_gopigo3_msg__srv__SPI_Event__Sequence__are_equal(const ros2_gopigo3_msg__srv__SPI_Event__Sequence * lhs, const ros2_gopigo3_msg__srv__SPI_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ros2_gopigo3_msg__srv__SPI_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
ros2_gopigo3_msg__srv__SPI_Event__Sequence__copy(
  const ros2_gopigo3_msg__srv__SPI_Event__Sequence * input,
  ros2_gopigo3_msg__srv__SPI_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ros2_gopigo3_msg__srv__SPI_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ros2_gopigo3_msg__srv__SPI_Event * data =
      (ros2_gopigo3_msg__srv__SPI_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros2_gopigo3_msg__srv__SPI_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros2_gopigo3_msg__srv__SPI_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ros2_gopigo3_msg__srv__SPI_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
