...
enum
{
  ros2_gopigo3_msg__srv__SPI_Event__request__MAX_SIZE = 1
};
// response
enum
{
  ros2_gopigo3_msg__srv__SPI_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SPI in the package ros2_gopigo3_msg.
typedef struct ros2_gopigo3_msg__srv__SPI_Event
{
  service_msgs__msg__ServiceEventInfo info;
  ros2_gopigo3_msg__srv__SPI_Request__Sequence request;
  ros2_gopigo3_msg__srv__SPI_Response__Sequence response;
} ros2_gopigo3_msg__srv__SPI_Event;

// Struct for a sequence of ros2_gopigo3_msg__srv__SPI_Event.
typedef struct ros2_gopigo3_msg__srv__SPI_Event__Sequence
{
