...
<< ////
    FILE:  /home/ubuntu/LyricalDave/ros2ws/start_wo_Dave.sh

    PURPOSE:  Start without dave_node for testing subsystems such as docking and battery

This file starts the needed LyricalDave nodes w/o starting the dave_node (7 python processes in status.sh):
