...
#
# Update:
#    2026-06: Using pi-ina219 for ina219.  Using easy_ina219 and noinit_easygopigo3 from plib
...
REV_PROTECT_DIODE = 0.52    # The GoPiGo3 has a reverse polarity protection diode drop of 0.5v to 0.8v (n=3)
                            # This value results in average readings vs battery voltage error of +/- 0.03
                            # 2026: adjusted to match ina219 voltage reading
