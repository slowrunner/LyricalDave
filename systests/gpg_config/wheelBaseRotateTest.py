...
# to put in $HOME/.gpg_config.json
#
# Operation:
>Spin 360 Wheel Dia:66.50 Base:117.0 mm?  (? for help)
 ...
 j       write current wbase and wdia to $HOME/.gpg3_config.json
 q       (or ctrl-c) Exit
...
print("wheel diameter and wheel-base read from $HOME/.gpg_config.json")
...
while True:
    ...
    if len(i) == 0:
        ...
        print("j       write current wbase and wdia to $HOME/.gpg3_config.json")
        ...
        print("Wrote new robot constants to $HOME/.gpg3_config.json")
        continue
    elif i[0] == "q":
        print("Exiting...")
        egpg.stop()
