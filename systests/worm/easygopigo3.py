...
class _mock_dist_sensor:
    ...
    def read_mm():
        print("\n*****")
        dist=float(input("* Distance in mm? "))
        print("*****\n")
        return dist
...
class EasyGoPiGo3(gopigo3.GoPiGo3):
    ...
    def set_speed(self, in_speed):
        ...
        self.set_motor_limits(self.MOTOR_LEFT + self.MOTOR_RIGHT,
                              dps=self.speed)
        print(f"Motor speed limits (left+right) set to {self.speed}")
    ...
    def reset_speed(self):
        ...
        """
        self.set_speed(self.DEFAULT_SPEED)
        print(f"Reset motor speed (limits) to {self.DEFAULT_SPEED}")
    ...
    def stop(self):
        ...
        time.sleep(0.1)
        print("Motors stopped and floated")
    ...
    def forward(self):
        ...
        """
        print(f"Forward at {self.NO_LIMIT_SPEED} limited by {self.speed}")
    ...
    def backward(self):
        ...
        """
        print(f"Backward at {self.NO_LIMIT_SPEED * -1} limited by {self.speed}")
        self.set_motor_dps(self.MOTOR_LEFT + self.MOTOR_RIGHT,
    ...
    def right(self):
        ...
        """
        print(f"Right motor only at {self.NO_LIMIT_SPEED} limited by {self.speed}")
    ...
    def left(self):
        ...
        """
        print(f"Left motor only at {self.NO_LIMIT_SPEED} limited by {self.speed}")
    ...
    def open_eyes(self):
        ...
        """
        left=self.left_eye_color
        right=self.right_eye_color
        print(f"Left Eye on {left} Right Eye On {right}")
    ...
    def init_ultrasonic_sensor(self, port="AD1"):
        ...
        """
        print("INIT_ULTRASONIC_SENSOR() to _mock_dist_sensor")
        return _mock_dist_sensor
