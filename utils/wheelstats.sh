...
#
echo "WHEEL STATS"
fn="/home/ubuntu/LyricalDave/logs/wheel.log"

echo "(Cleaning life.log first)"
/home/ubuntu/LyricalDave/plib/cleanlifelog.py
echo " "
...
totalLife=`(awk -F':' '{sum+=$3}END{printf "%.1f", sum;}' /home/ubuntu/LyricalDave/logs/life.log)`
